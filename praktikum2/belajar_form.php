      ...
      <fieldset>
        ...
        <table>
          <tr>
            ...
            <td>:</td>
            <td><input type="text" name="student_name" value="<?= $student_name ?>" size="20" placeholder="Nama Anda"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>:</td>
            <td>
              <input type="radio" name="student_gender" value="man" id="pria" <?= $checked_man ?>><label for="pria">Pria</label>
          ...
          <tr>
            <td>URL Website*</td>
            <td>:</td>
            <td><input type="url" name="student_website" value="<?= $student_website ?>" size="40" placeholder="URL Website Anda"></td>
          </tr>
        </table>
      </fieldset>
